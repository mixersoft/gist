...
set DeviceIdInstallerDir=..\device-id-installer\bin\%Config%\
...
candle -dclient.TargetPath="%Target%" -dclient.ProjectDir="%ProjectDir%" -ddevice-id-installer.TargetDir="%DeviceIdInstallerDir%" -nologo -o "%Obj%" "%Src%.wxs"
